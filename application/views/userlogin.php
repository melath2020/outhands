...
<!--//webfonts--> 
<!--animate-->
<link href="<?php echo base_url();?>admin_assets/css/animate.css" rel="stylesheet" type="text/css" media="all">
...
<script src="<?php echo base_url();?>admin_assets/js/underscore-min.js" type="text/javascript"></script>
<script src= "<?php echo base_url();?>admin_assets/js/moment-2.2.1.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>admin_assets/js/clndr.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>admin_assets/js/site.js" type="text/javascript"></script>
<!--End Calender-->
<!-- Metis Menu -->
				...
				<div class="tables">
					...
					<div class="panel-body widget-shadow">
                      ...
                      <th>Deactivate</th>
						   ...
						   <tbody><?php $i=0; { foreach ($display as $data) { $i++;?>
